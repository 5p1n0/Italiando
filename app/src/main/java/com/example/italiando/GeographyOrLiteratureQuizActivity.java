...
public class GeographyOrLiteratureQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (subject.equals(getString(R.string.foods))) {
            questionsAnswerMap = Utils.getRandomLiteratureAndGeographyQuestions(this,getString(R.string.foods),Constants.QUESTION_SHOWING);
            tvTitle.setText(getString(R.string.foods_quiz));
        }else if (subject.equals(getString(R.string.Intro))) {
            questionsAnswerMap = Utils.getRandomLiteratureAndGeographyQuestions(this,getString(R.string.Intro),Constants.QUESTION_SHOWING);
            tvTitle.setText(getString(R.string.Intro_quiz));
        }else if (subject.equals(getString(R.string.animals))) {
            questionsAnswerMap = Utils.getRandomLiteratureAndGeographyQuestions(this,getString(R.string.animals),Constants.QUESTION_SHOWING);
            tvTitle.setText(getString(R.string.animals_quiz));
        } else {
            questionsAnswerMap = Utils.getRandomLiteratureAndGeographyQuestions(this,getString(R.string.numbers),Constants.QUESTION_SHOWING);
            tvTitle.setText(getString(R.string.numbers_quiz));
        }
